...
import { ShieldCheck, Lock, User as UserIcon, ArrowLeft, Loader2, Eye, EyeOff } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="bg-surface border border-border p-8 rounded-2xl shadow-2xl w-full max-w-md z-10 relative">
        ...
        <div className="mt-8 text-center text-sm text-slate-500 border-t border-border pt-6">
          ...
          <Link to="/register" className="text-primary font-semibold hover:text-blue-400 transition-colors">
            Create one now
          </Link>
        </div>
      </div>
