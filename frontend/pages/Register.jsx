...
import { ShieldCheck, Lock, User as UserIcon, Mail, ArrowLeft, CheckCircle2, Loader2, Eye, EyeOff } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="bg-surface border border-border p-8 rounded-2xl shadow-2xl w-full max-w-md z-10 relative">
        ...
        <div className="text-center mb-8">
           ...
           <p className="text-slate-400 mt-2 text-sm">Join Wassila and start analyzing</p>
        </div>
        ...
        <form onSubmit={handleRegister} className="space-y-5">
          ...
          <div>
            ...
            {confirmPassword && password !== confirmPassword && (
                <p className="text-red-500 text-[10px] mt-1 ml-1">Passwords do not match</p>
            )}
          </div>
